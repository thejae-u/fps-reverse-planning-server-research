...
public:
    ...
    : _name(name), _blockingPool(blockingThreadCount), _guard(asio::make_work_guard(_io))
    {
    ...
    {
        auto newIOManager = std::make_shared<IOManager>(SecretKey{}, name, blockingThreadCount);
