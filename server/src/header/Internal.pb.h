...
/* @@protoc_insertion_point(class_definition:Internal.MatchCreateRequest) */ {
 ...
 public:
  ...
  public:
  void clear_users() ;
  ::Internal::UserSessionInfo* PROTOBUF_NONNULL mutable_users(int index);
  ::google::protobuf::RepeatedPtrField<::Internal::UserSessionInfo>* PROTOBUF_NONNULL mutable_users();
...
inline const ::Internal::MatchCreateRequest& GamePacket::_internal_match_create_req() const {
  return payload_case() == kMatchCreateReq ? static_cast<const ::Internal::MatchCreateRequest&>(*_impl_.payload_.match_create_req_)
                     : reinterpret_cast<const ::Internal::MatchCreateRequest&>(::Internal::_MatchCreateRequest_default_instance_);
}
...
inline const ::Internal::MatchCreateResponse& GamePacket::_internal_match_create_res() const {
  return payload_case() == kMatchCreateRes ? static_cast<const ::Internal::MatchCreateResponse&>(*_impl_.payload_.match_create_res_)
                     : reinterpret_cast<const ::Internal::MatchCreateResponse&>(::Internal::_MatchCreateResponse_default_instance_);
}
...
inline ::google::protobuf::RepeatedPtrField<::Internal::UserSessionInfo>* PROTOBUF_NONNULL MatchCreateRequest::mutable_users()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
